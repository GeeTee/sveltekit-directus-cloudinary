<script>
    ...
    async function handleLogin () {
        ...
        .then( async (user) => {
            ...
            $session.user = {...user}
            u.setUser(user) // ????
            console.log('login 2 session user', $session.user)
            return user
        })
...
<Div
    ...
    beWell=true
>
    <form id="login-form" role="form" name="login">
        ...
        <div class="columns">
            <div class="field column">
                ...
                <div class="control has-icons-left">
                    ...
                    on:blur={() => {helpEmail = toggleHelp(email, 'email')}}
            ...
            <div class="field column">
                ...
                <div class="control has-icons-left">
                    ...
                    on:blur={() => {helpPassword = toggleHelp(password, 'password')}}
                    placeholder="Noter un mail valide"
                    bind:value={password}
                    required
                    >
